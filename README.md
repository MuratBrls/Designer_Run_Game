...
### Yöntem 1: Doğrudan Tarayıcıda Çalıştırma (Web)
...
### Yöntem 2: Masaüstü Uygulaması Olarak Çalıştırma (Electron)
Oyun Electron framework'ü ile masaüstü uygulaması olarak yapılandırılmıştır.
...
### Yöntem 3: Windows EXE Kurulum Paketini Oluşturma
